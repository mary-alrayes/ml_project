...
if __name__ == "__main__":
    ...
    monk3_train_data = monk3_train_data.sample(frac=1).reset_index(drop=True)
    ...
    monk3_train_X, monk3_train_Y, monk3_validation_X, monk3_validation_Y = preprocessClassData(monk3_train_data)
    ...
    monk3_real_test_X, monk3_real_test_Y = splitToFeaturesAndTarget(one_hot_test_monk3)
