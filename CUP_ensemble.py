...
#---------------Plot a graph with Loss and Training MSE---------------------
    ...
    # Plot Validation Loss
    plt.plot(history['epoch'], history['val_loss'], label='Assessment Loss(MSE)', color='red', linestyle='-')
...
#-------------Plot a graph with Loss and Training MEE---------------------------
    ...
    # Plot Training MEE
    plt.plot(history['epoch'], history['train_mee'], label='Training Loss (MEE)', color='blue', linestyle='--')
    
    # Plot Validation MEE
    plt.plot(history['epoch'], history['val_mee'], label='Assessment Loss (MEE)', color='red', linestyle='--')
